...
SUITE(street_queries_perf) {
    ...
    //Add a unit test here to test the performance of "find_street_ids_from_name"
    // ...
    TEST_FIXTURE(MapFixture, street_ids_from_street_names_perf){
        ...
        expected = {3341, 16558};
        actual = find_street_ids_from_name("Jarvis Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {422,1768,6303,6487,6799,7441,17392,18486};
        actual = find_street_ids_from_name("Queen Street East");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {133};
        actual = find_street_ids_from_name("Bathurst Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {195,6192,19510};
        actual = find_street_ids_from_name("King Street West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {259,270,914,4483};
        actual = find_street_ids_from_name("Spadina Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {282,6231};
        actual = find_street_ids_from_name("Wellington Street West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {304, 19696};
        actual = find_street_ids_from_name("Finch Avenue East");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {120,7021};
        actual = find_street_ids_from_name("Bloor Street West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        ...
        expected = {1534};
        actual = find_street_ids_from_name("Dupont Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {1463,1469};
        actual = find_street_ids_from_name("Eglinton Avenue West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {148,151,5138};
        actual = find_street_ids_from_name("Dufferin Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {917,1024};
        actual = find_street_ids_from_name("Lawrence Avenue West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {301,10498};
        actual = find_street_ids_from_name("Dundas Street West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {3863,14613,16933};
        actual = find_street_ids_from_name("Wilson Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {3016};
        actual = find_street_ids_from_name("Sheppard Avenue West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {13,385,10499,17289};
        actual = find_street_ids_from_name("Steeles Avenue West");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {734,5066,14692,17170,17179,17209,17262,17369,18974};
        actual = find_street_ids_from_name("Kennedy Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {1679,2860};
        actual = find_street_ids_from_name("Lauder Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {1851,2631};
        actual = find_street_ids_from_name("Cross Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {2635};
        actual = find_street_ids_from_name("Bank Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {954};
        actual = find_street_ids_from_name("Cecil Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {372,1783,14167};
        actual = find_street_ids_from_name("Robert Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {1499,1505};
        actual = find_street_ids_from_name("Essex Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {300};
        actual = find_street_ids_from_name("Barton Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {1403,1507};
        actual = find_street_ids_from_name("Yarmouth Road");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {2287,18408};
        actual = find_street_ids_from_name("16th Avenue");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
        
        expected = {396,4896,4897,13832,13849};
        actual = find_street_ids_from_name("Oxford Street");
        std::sort(actual.begin(), actual.end());
        CHECK_EQUAL(expected,actual);
