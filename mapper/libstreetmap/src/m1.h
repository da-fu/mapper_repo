...
//function to store the map in the form of street-name-to-id in a hash table
void load_int_name_to_id();

void load_stName_to_ids();

void load_POIname_to_ids();
// function to store the map in the form of streetid-to-street-segment-id in a hash table
void load_stid_to_stSeg_ids();

//function to store the map in the form of intersectionid-to-segment-id in a hash table
void load_ints_to_segs_ints_to_adjacents_streetnames_to_ints();

// function to store the map in a vector of vectors, index: segment ids, elements: length
